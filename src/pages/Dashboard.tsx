...
import { BookOpen, FileText, BarChart3, ClipboardList, Bell, CalendarCheck } from "lucide-react";
...
export default function Dashboard() {
  ...
  const quickLinks = [
    ...
    { label: "Attendance", icon: CalendarCheck, path: "/attendance", color: "gradient-blue" },
  ];
